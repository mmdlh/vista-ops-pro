...
function Overview() {
  ...
  const trend: EChartsOption = { legend: { top: 10, data: ["电力负荷", "设备负载", "环境温度"] }, grid: { top: 56 }, xAxis: { type: "category", data: ["00", "04", "08", "12", "16", "20", "24"] }, yAxis: [{ type: "value", name: "kW" }, { type: "value", name: "% / °C" }], series: [{ name: "电力负荷", type: "line", smooth: true, areaStyle: { opacity: .1 }, data: [480, 430, 680, 790, 750, 620, 510] }, { name: "设备负载", type: "line", smooth: true, yAxisIndex: 1, data: [51, 48, 76, 89, 83, 72, 58] }, { name: "环境温度", type: "line", smooth: true, yAxisIndex: 1, data: [24, 23, 26, 29, 28, 26, 25] }] };
...
function Telemetry() {
  ...
  const waveOption: EChartsOption = { animationDurationUpdate: 500, legend: { top: 10, data: ["主轴振动", "轴承振动"] }, grid: { top: 56 }, xAxis: { type: "category", show: false, data: Array.from({ length: 30 }, (_, i) => i) }, yAxis: { type: "value", min: 45, max: 75 }, series: [{ name: "主轴振动", type: "line", smooth: true, symbol: "none", areaStyle: { opacity: .12 }, data: wave(0) }, { name: "轴承振动", type: "line", smooth: true, symbol: "none", data: wave(4) }] };
...
function Spares() {
  ...
  const stock: EChartsOption = { legend: { top: 10, data: ["入库", "出库", "库存金额"] }, grid: { top: 56 }, xAxis: { type: "category", data: ["4月", "5月", "6月", "7月", "8月", "9月"] }, yAxis: [{ type: "value" }, { type: "value" }], series: [{ name: "入库", type: "bar", data: [82, 96, 76, 112, 89, 105] }, { name: "出库", type: "bar", data: [65, 88, 91, 73, 102, 96] }, { name: "库存金额", type: "line", yAxisIndex: 1, smooth: true, data: [128, 136, 132, 145, 139, 142] }] };
...
function Diagnostics() {
  const decline: EChartsOption = { legend: { top: 10, data: ["健康指数", "预测值", "检修阈值"] }, grid: { top: 56 }, xAxis: { type: "category", data: ["4月", "5月", "6月", "7月", "8月", "9月", "10月", "11月"] }, yAxis: { type: "value", min: 50, max: 100 }, series: [{ name: "健康指数", type: "line", smooth: true, data: [94, 92, 90, 88, 85, 81, null, null] }, { name: "预测值", type: "line", smooth: true, lineStyle: { type: "dashed" }, data: [null, null, null, null, null, 81, 76, 69] }, { name: "检修阈值", type: "line", symbol: "none", data: [70,70,70,70,70,70,70,70], lineStyle: { color: palette[4], type: "dotted" } }] };
